...
<section class="entry-list-item entry-list-item--phrase" data-sort-title="{{ item.title | downcase | escape }}" data-source-path="{{ item.path | escape }}" data-alpha-index="{{ forloop.index0 }}" data-updated-at="{{ item.updated_at | default: '' | escape }}">
